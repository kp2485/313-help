...
const PATHS: Record<string, string> = {
  ...
  // A neighborhood: a block with a pin in it, for the Neighborhoods tab. Not the house that means Home and not
  // the bare pin that means Map, so the three tabs are told apart at a glance.
  district: 'M4 6h16v12H4z M12 15.5s-3-2.8-3-5.2a3 3 0 0 1 6 0c0 2.4-3 5.2-3 5.2z M12 10.1h.01',
