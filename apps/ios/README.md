...
2. Delete the generated `ContentView.swift` and the `…App.swift` file. Drag in the five files from `DetroitCompassApp/`, choosing **Create groups** and leaving **Copy items** unticked.
