...
- 2026-09-20 (coordinated build): **528 listings, four tabs with one Map, an accessibility pass, an Android client written, and the deploy blockers cleared down to Kyle's own steps.**
  ...
  - *Checks:* `pnpm test` is **487** (query 111, api 80, pipeline 172, web 124), plus 111 Swift fixture cases and 28 iOS app tests. Differences for a steward are in **[CHECKS-2026-09-20.md](CHECKS-2026-09-20.md)**.
