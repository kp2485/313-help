...
**Service area:** every city and township a DDOT or SMART bus stops in or runs through — 75 places in Wayne, Oakland and Macomb counties, worked out from the two feeds by `pnpm ingest:region` (Kyle, 2026-09-24; DECISIONS). Until then it was Detroit, Hamtramck, Highland Park and Dearborn (2026-09-19). A place outside it is not listed.
