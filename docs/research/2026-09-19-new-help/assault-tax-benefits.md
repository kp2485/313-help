...
| 13 | **YWCA Metro Detroit – Interim House** (DV shelter and services) | DV crisis line and advocacy. The page does not mention sexual-assault services. | Free | Administrative office address removed on 2026-09-21 (Kyle): no address of any kind is kept for a domestic-violence organization, office or shelter. The shelter address is confidential; never list it. | "24-Hour Crisis Line: 313-861-5300" | 24h line | call | Detroit | ywcadetroit.org: **curl 403** ("403 - Forbidden"); read with WebFetch | **partial / blocks scripts.** Better suited to the DV lane. Listed here only because the MDHHS directory groups it with SA services. |
