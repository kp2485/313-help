...
|---|---|---|
| `data/ingested/transit/intercity_bus.json` | US DOT, Bureau of Transportation Statistics — NTAD Intercity Bus Atlas Stops | **CC BY-NC 4.0** (<https://creativecommons.org/licenses/by-nc/4.0/>). Attribution required; **not for commercial use**. **Not licensed under Apache-2.0.** Modified: filtered to the box around the 75 cities and townships a DDOT or SMART bus reaches, plus a small margin, and reduced to the fields the app draws — 10 stops of the national file |
